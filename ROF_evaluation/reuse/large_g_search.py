...
argparser.add_argument('--datasetname', '-d', type=str, default='ogbn-papers100M')
...
env CUDA_VISIBLE_DEVICES=1 python large_g_search.py -d ogbn-papers100M -ps 3 -rf 0
'''

log_file_name = "large_g_search"
...
t_stamp,t_delta = t_click("-------------------- load_graph over: ",  t_stamp)
t_name_list.append("load_graph over")
t_delta_list.append(t_delta)
t_stamp_list.append(t_stamp)
...
# ##### 
# ogbn-papers100M has 116M edges, 3-hop has 12% edges 
    # len(delta_node_idx_set):  24294634 
    # len(cur_node_idx_set):  11833690 
    # len(cur_node_idx_set)/len(delta_node_idx_set)+1:  0.48709068842115505 
    # num_edges/full_num_edges: 210310405 1726745828 0.12179580896604315 
######################################################### 
t_stamp,t_delta = t_click("-------------------- induced_k_hop_subgraph over: ",  t_stamp)
t_name_list.append("induced_k_hop_subgraph over")
t_delta_list.append(t_delta)
t_stamp_list.append(t_stamp)
...
t_stamp,t_delta = t_click("-------------------- convert csr,csc over: ",  t_stamp)
t_name_list.append(" convert csr,csc over")
t_delta_list.append(t_delta)
t_stamp_list.append(t_stamp)
